...
def create_login_box():
    global username_entry, password_entry, login_window  # Make login_window global
...
def login():
    ...
    if username and password:
        if check_login_credentials(username, password):
            login_box.place_forget() #diko alam kung bakit di gumana to or kung login_box.destroy() gagamitin ko
...
#tinanggal ko na yung login_window = None
